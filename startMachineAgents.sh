...
echo "Starting machine agent on webserver container..."; docker exec webserver /runMachineAgent.sh; echo "Done"
echo "Starting machine agent on cpp_app container..."; docker exec cpp_app /runMachineAgent.sh; echo "Done"